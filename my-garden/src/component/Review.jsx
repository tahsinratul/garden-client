    ...
    return (
        ...
        <div className="flex flex-col items-center">
            <div className="text-center">
                <h2 className="mt-4 text-3xl font-bold text-[#021100] sm:text-4xl xl:text-5xl font-pj">Our happy clients say about us</h2>
            </div>
            <div className="relative mt-10 md:mt-24 md:order-2">
                ...
                <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                    <div className="flex flex-col overflow-hidden rounded-2xl shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-[#DBF6D7] rounded-2xl lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“You made it so simple. My new garden is so much healthy and beautiful. I just choose the page, make the change.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div className="flex items-center mt-8">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Gardener</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col rounded-2xl overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 rounded-2xl p-6 bg-[#DBF6D7] lg:py-8 lg:px-7">
                            <div className="flex-1">
                                <div className="flex items-center">
                                    <svg className="w-5 h-5 text-[#FDB241]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“Simply the best. Better than all the rest. I’d recommend this page to beginners and advanced users.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div className="flex items-center mt-8">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Plant Specialist</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col overflow-hidden rounded-2xl shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-[#DBF6D7] rounded-2xl lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“I cannot believe that I have got a new land for flower. It was super easy to work on it”</p>
                                </blockquote>
                            </div>
                            ...
                            <div className="flex items-center mt-8">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Flower Gardener</p>
                                </div>
                            </div>
                        </div>
                    </div>

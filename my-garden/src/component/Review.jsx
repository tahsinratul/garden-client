                        ...
                        <div class="flex flex-col justify-between flex-1 p-6 bg-[#DBF6D7] rounded-2xl lg:py-8 lg:px-7">
                            <div class="flex-1">
                                ...
                                <blockquote class="flex-1 mt-8">
                                    <p class="text-lg leading-relaxed text-gray-900 font-pj">“You made it so simple. My new garden is so much healthy and beautiful. I just choose the page, make the change.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div class="flex items-center mt-8">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-0.5 text-sm font-pj text-gray-600">Gardener</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col rounded-2xl overflow-hidden shadow-xl">
                        <div class="flex flex-col justify-between flex-1 rounded-2xl p-6 bg-[#DBF6D7] lg:py-8 lg:px-7">
                            <div class="flex-1">
                                ...
                                <blockquote class="flex-1 mt-8">
                                    <p class="text-lg leading-relaxed text-gray-900 font-pj">“Simply the best. Better than all the rest. I’d recommend this page to beginners and advanced users.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div class="flex items-center mt-8">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-0.5 text-sm font-pj text-gray-600">Plant Specialist</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col overflow-hidden rounded-2xl shadow-xl">
                        <div class="flex flex-col justify-between flex-1 p-6 bg-[#DBF6D7] rounded-2xl lg:py-8 lg:px-7">
                            <div class="flex-1">
                                ...
                                <blockquote class="flex-1 mt-8">
                                    <p class="text-lg leading-relaxed text-gray-900 font-pj">“I cannot believe that I have got a new land for flower. It was super easy to work on it”</p>
                                </blockquote>
                            </div>
                            ...
                            <div class="flex items-center mt-8">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-0.5 text-sm font-pj text-gray-600">Flower Gardener</p>
                                </div>
                            </div>
                        </div>
                    </div>
